        ...
        <main class="flex flex-row h-full flex-wrap md:flex-nowrap">
            ...
            if (isset($_GET['user']) && is_numeric($_GET['user'])) {
                ...
                if ($user) {
                    ...
                    echo '<div class="flex flex-col p-5 m-5 gap-5">
                ...
                <div class="flex flex-row gap-3">
                    <div class="flex flex-col bg-purple-950 basis-3/4 p-5 rounded-xl gap-3">
                        <h1 class="text-3xl mt-auto">' . $username . '\'s feed:</h1>
                        <div class="bg-orange-800 text-white rounded-md border-l-cyan-500 border-l-4 p-3">
                            ...
                            <div class="flex flex-row mt-3 gap-5">
                                ...
                                <button class="group border-none rounded-xl text-white uppercase font-bold ml-auto"><span class="material-symbols-outlined group-hover:bg-orange-500 rounded-full p-1 transition-all ease-in-out">comment</span><br>10</span></button>
                            </div>
                        </div>
                    </div>
